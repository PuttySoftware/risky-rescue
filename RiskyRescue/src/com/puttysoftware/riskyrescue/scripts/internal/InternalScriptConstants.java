...
public class InternalScriptConstants {
    ...
    public static final int[] ARGUMENT_COUNT_VALIDATION = new int[] { ARGC_NONE,
            ARGC_MESSAGE, ARGC_SOUND, ARGC_SHOP, ARGC_DECAY, ARGC_REDRAW,
            ARGC_SWAP_PAIRS, ARGC_ADD_TO_SCORE, ARGC_RANDOM_CHANCE, ARGC_BATTLE,
    ...
    public static final Class<?>[][] ARGUMENT_TYPE_VALIDATION = new Class[][] {
            ARGT_NONE, ARGT_MESSAGE, ARGT_SOUND, ARGT_SHOP, ARGT_DECAY,
            ARGT_REDRAW, ARGT_SWAP_PAIRS, ARGT_ADD_TO_SCORE, ARGT_RANDOM_CHANCE,
